...
function! mark#palettes#Extended()
	return [
		...
		\   { 'ctermbg':'lightCyan',   'ctermfg':'white', 'guibg':'#D2A1FF', 'guifg':'#420080' },
		\   { 'ctermbg':'lightGreen',  'ctermfg':'white', 'guibg':'#D0FFA1', 'guifg':'#3F8000' },
		\   { 'ctermbg':'Brown',      'ctermfg':'white', 'guibg':'#FFC4A1', 'guifg':'#803000' },
		\   { 'ctermbg':'lightMagenta','ctermfg':'white', 'guibg':'#A29CCF', 'guifg':'#120080' },
		\   { 'ctermbg':'lightBlue',   'ctermfg':'white', 'guibg':'#A1DBFF', 'guifg':'#004E80' },
		\   { 'ctermbg':'lightRed',    'ctermfg':'white', 'guibg':'#F5A1FF', 'guifg':'#720080' },
		\   { 'ctermbg':'lightcyan',      'ctermfg':'darkred', 'guibg':'#53534C', 'guifg':'#DDDDDD' },
		\   { 'ctermbg':'lightgreen',       'ctermfg':'darkred', 'guibg':'#0000FF', 'guifg':'#F0F0FF' },
		\   { 'ctermbg':'lightMagenta',    'ctermfg':'darkred', 'guibg':'#FF0000', 'guifg':'#FFFFFF' },
		\   { 'ctermbg':'lightblue',      'ctermfg':'darkred',  'guibg':'#131311', 'guifg':'#AAAAAA' },
		\   { 'ctermbg':'White',      'ctermfg':'darkred',  'guibg':'#E3E3D2', 'guifg':'#999999' },
		\   { 'ctermbg':'LightGray',  'ctermfg':'darkblue', 'guibg':'#D3D3C3', 'guifg':'#666666' },
		\   { 'ctermbg':'Gray',       'ctermfg':'darkcyan', 'guibg':'#A3A396', 'guifg':'#222222' },
		\]
endfunction
